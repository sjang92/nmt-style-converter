...
class BeamFlattenWrapper(core_rnn_cell.RNNCell):
...
class BeamReplicateWrapper(core_rnn_cell.RNNCell):
    def __init__(self, cell, beam_size):
        self.cell = cell
        self.beam_size = beam_size
...
class BeamSearchHelper(object):
    ...
    def __init__(self, cell, beam_size, stop_token, initial_state, initial_input,
        ...
        if cell_transform == 'default':
            if type(cell) in [core_rnn_cell.LSTMCell,
                              core_rnn_cell.GRUCell,
                              core_rnn_cell.BasicLSTMCell,
                              core_rnn_cell.BasicRNNCell]:
...
def beam_decoder(
    ...
    Args:
        cell: core_rnn_cell.RNNCell defining the cell to use
